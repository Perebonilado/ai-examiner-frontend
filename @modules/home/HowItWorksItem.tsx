...
import TransitionRight from "@/transitions/TransitionRight";
...
const HowItWorksItem: FC<HowItWorksItemProps> = ({
  ...
  const isEven = (Number(index) + 1) % 2 === 0;
  return (
    <div className="flex even:flex-row-reverse gap-10 max-lg:!flex-col max-lg:items-center">
      ...
      {!isEven && (
        <TransitionRight className="w-[55%] h-[500px] max-lg:w-full max-lg:h-[350px]">
          <div className="w-[100%] h-[100%] bg-[#F9F1FF] rounded-xl flex items-center justify-center">
      ...
      {isEven && (
        <TransitionLeft className="w-[55%] h-[500px] max-lg:w-full max-lg:h-[350px]">
          <div className="w-[100%] h-[100%] bg-[#F9F1FF] rounded-xl flex items-center justify-center">
            <div className="relative h-[70%] w-[75%] max-lg:w-[90%] max-lg:h-[80%]">
              <Image
                layout="fill"
